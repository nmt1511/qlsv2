...
public class Student implements Serializable {
    ...
    public Student(String id_class, String name_class, String id_student, String code_student, String name_student, String gender,
                   String birthday_student, String address_student) {
        super();
